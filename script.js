...
// Manipulando o inpit amount para receber somente números.
amount.addEventListener("input", () => {
  const hasCharactersRegex = /\D+/g; // Expressão regular para aceitar apenas números.
